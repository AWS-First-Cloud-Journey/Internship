...
- [x] **Mục tiêu 2**: Tìm hiểu về bộ công cụ ML/AI của AWS (Amazon Transcribe, Comprehend, Rekognition, Polly) và cách tích hợp chúng vào các ứng dụng
...
- **Tools/Tech**: Amazon Q Developer, AWS IDE Toolkit
- **Links**: N/A
...
- **Tools/Tech**: Amazon Transcribe, Amazon Comprehend, Amazon Rekognition, Amazon Polly
- **Links**: N/A
