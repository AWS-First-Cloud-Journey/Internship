...
- [x] **Mục tiêu 1**: Hiểu sâu về kiến trúc và nguyên lý hoạt động của Amazon ECS, sẵn sàng trình bày trong workshop 01
...
- **Tools/Tech**: Amazon ECS, AWS Fargate
- **Links**: N/A

### 2. Tìm hiểu ECR ⏱️ 11:30 - 13:00
- **Mô tả**: Thực hiện tìm hiểu về Amazon Elastic Container Registry (ECR) để hiểu cách lưu trữ và quản lý Docker images trên AWS. 
...
- **Tools/Tech**: Amazon ECR, Docker
- **Links**: N/A

### 3. Thiết lập Flyway cho dự án và nghiên cứu về CI/CD cơ bản ⏱️ 14:00 - 17:00
- **Mô tả**: Thực hiện thiết lập Flyway để quản lý database migration cho dự án và tìm hiểu về CI/CD cơ bản. Thực hành tích hợp Flyway vào quy trình CI/CD pipeline.
...
- **Tools/Tech**: Flyway, Database Migration
- **Links**: N/A
