...
- **Tools/Tech**: AWS CodePipeline, CodeBuild
- **Links**: N/A
...
- **Improvement**: Cần ghi chép chi tiết hơn về các vấn đề gặp phải với CodeBuild và CodePipeline.
...
- **Areas for Growth**: Cần tìm hiểu sâu hơn về cách tối ưu hóa cấu hình build để giảm thời gian triển khai.
