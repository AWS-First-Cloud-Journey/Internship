...
### 1. Lab04: triển khai 1 ứng dụng node.js trên ec2 windows bằng cách cấu hình csdl và môi trường trên các ec2 đó ⏱️ 6.0 giờ
- **Mô tả**: - Lab04: triển khai 1 ứng dụng node.js trên ec2 windows bằng cách cấu hình csdl và môi trường trên các ec2 đó
...
### Priority Tasks
- [ ] **Medium**: -Tìm hiểu dịch vụ lưu trữ
