...
- [x] Thực hiện bài lab về Setting up VPC Peering

## 💼 Công việc đã thực hiện

### 1. Setting up VPC Peering ⏱️ 20:00-23:00
- **Mô tả**: 
**Source:** AwsStudyGroup.
- Setting up VPC Peering.
**Task:**  
- Module 02-Lab19-01 - Introduction.
- Module 02-Lab10-02.1 - Initialize CloudFormation Template.
- Module 02-Lab10-02.2 - Create Security Group.
- Module 02-Lab10-02.3 - Create EC2 Instance.
- Module 02-Lab10-03 - Update Network ACL.
- Module 02-Lab10-04 - VPC Peering.
- Module 02-Lab10-05 - Route Tables.
- Module 02-Lab10-06 - Cross-Peer DNS.
- Module 02-Lab10-07 - Cleanup.
  
- **Kết quả**: 
  Module02_Lab19
  
  **📎 Deliverables & Links:**
  - [🧪 Module02_Lab19](https://docs.google.com/document/d/1pDo0PrpNBGxKf60z6PpYAAUCW_V5OQUw/edit?usp=sharing&ouid=110340836613785847223&rtpof=true&sd=true)
  
- **Status**: 😍 Completed

- **Tools/Tech**: AWS Console, VS Code, Terminal, EC2, VPC, CLOUDFORMATION
...
- [Today's Work: Module02_Lab19](https://github.com/nguyenvietquoc/aws-labs/tree/main/module02/lab19)
...
**🎯 Week Progress:**
Day 5/7 completed. On track với week 2 goals.

---
*Worklog created by: Nguyễn Viết Quốc - FCJ Intern*  
*Next review: 24/05/2025 - Daily standup*