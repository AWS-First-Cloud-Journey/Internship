...
- [x] tìm hiểu về các dịch vụ liên quan tới EC2: AMI / Backup / Key pair, Elastic Block Store....

## 💼 Công việc đã thực hiện

### 1. Compute VM on AWS ⏱️ 20:00-23:00
- **Mô tả**: 
**Task:** AwsStudyGroup.
- Xem mô-đun 3 trong nhóm nghiên cứu AWS.
**Goal:**  
1. Khái niệm sơ lượt về EC2.
2. EC2 - AMI / Backup / Key pair.
3. EC2 - Elastic Block Store.
...
- **Tools/Tech**: AWS Console, VS Code, Terminal, EC2, AUTO SCALING
...
**🎯 Week Progress:**
Day 7/7 completed. On track với week 2 goals.

---
*Worklog created by: Nguyễn Viết Quốc - FCJ Intern*  
*Next review: 26/05/2025 - Daily standup*