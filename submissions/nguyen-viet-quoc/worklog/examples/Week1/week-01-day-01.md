...
- [x] Tìm hiểu cơ bản về AWS

## 💼 Công việc đã thực hiện

### 1. Learn knowledge
about basic AWS ⏱️ 19:00-23:00
- **Mô tả**: 
**Task:** AwsStudyGroup.
- Xem mô-đun 1 trong nhóm nghiên cứu AWS.
**Goal:**  
1. Khái niệm sơ lượt về Điện toán đám mây.
2. Lợi ích của điện toán đám mây.
3. Sự khác biệt của AWS với các nhà cung cấp dịch vụ khác.
4. Lời khuyên cho hành trình lên mây.
...
**🎯 Week Progress:**
Day 1/7 completed. On track với week 1 goals.

---
*Worklog created by: Nguyễn Viết Quốc - FCJ Intern*  
*Next review: 13/05/2025 - Daily standup*